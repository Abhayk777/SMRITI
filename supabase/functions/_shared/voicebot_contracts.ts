...
export type VoicebotSnapshotV1 = { version: 1; patient_id: string; display_name: string; language_code: string; timezone: string; active: boolean; revision: bigint; family_members: Array<{ external_id: string; name: string; relationship: string; memory_prompt: string | null; is_deceased: boolean }>; medicines: Array<{ external_id: string; name: string; dose: string; active: boolean; days_of_week: string; chosen_time_min: number; window_start_min: number; window_end_min: number }>; daily_routines: Array<{ external_id: string; time_min: number; activity: string }> };
